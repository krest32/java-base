...
public class JsonToolKrest {
    ...
    public String toString() {
        ...
        for (Map.Entry<String, Object> entry : set) {
            ...
            if (value instanceof JsonToolKrest) {
    ...
    public static String ListToStr(List<Object> list) {
        ...
        for (java.util.Iterator<Object> it = list.iterator(); it.hasNext();) {
            ...
            if (value instanceof Map) {
                sb.append(fromObject((Map)value)).append(",");
            } else if (isNoQuote(value)) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static JsonToolKrest fromObject(Object bean) {
        JsonToolKrest json = new JsonToolKrest();
        if (bean == null) {
            return json;
        }
     ...
     * @return
     */
    public static JsonToolKrest fromObject(Map<String, Object> map) {
        JsonToolKrest json = new JsonToolKrest();
        if (map == null) {
            return json;
        }
