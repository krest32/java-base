...
public class demo2 {
    public static void main(String[] args) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        //反射破解懒汉式
        Class<demo1> aClass = (Class<demo1>) Class.forName("com.krest.listener.Singleton.demo1");
...
~~~java
public class com.krest.cloud.client {
    public static void main(String[] args) {
...
public class Client {
    ...
    public static void main(String[] args) {
        Client com.krest.cloud.client = new Client();
        Adpatee adaptee = new Adpatee();
        Target target = new Adapter(adaptee);
        com.krest.cloud.client.test1(target);
    }
}
